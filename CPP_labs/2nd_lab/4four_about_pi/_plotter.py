...
paths_other = [
    '_files/euler.csv',
    '_files/gauss.csv',
    '_files/ramanujan.csv',
    '_files/leibnitz.csv',
    '_files/viete.csv'
]

labels_arctan = [
        'arctan(1)', 'arctan(1/2)+arctan(1/3)', '4arctan(1/5)-arctan(1/239)',
...
plt.title('Разложения $\pi/4$ через разложение арктангенса')
plt.grid(alpha=0.5)
...
plt.title('Разложения $\pi/4$ другими методами')
plt.grid(alpha=0.5)
plt.legend(loc='lower center')
