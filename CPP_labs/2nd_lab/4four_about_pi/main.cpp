...
void print_pi_into_files(long double tolerance, long unsigned iterations) {
// ---------------Arctan methods:------------------
    pi_from_arctans(
        {1.},
        {1.},
        tolerance,
        iterations, "./_files/arctan0.csv");
...
int main() {
    ...
    // print_pi_into_files(-1., 50);

    // print_dig_of_pi_into_files(50000);
    dig_pi_from_arctans(
        {1. / 2, 1. / 3},
        {1., 1.},
        50000, "./_files_reach_of_digits/dig_arctan1.csv");
